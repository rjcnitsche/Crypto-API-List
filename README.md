...
| [Bitfinex](https://docs.bitfinex.com/docs/introduction) | Exchange based in Hong Kong | `apiKey` | Yes | Unknown |
| [Bitmex](https://www.bitmex.com/app/apiOverview) | Real-Time Cryptocurrency derivatives trading platform based in Hong Kong | `apiKey` | Yes | Unknown |
| [Bittrex](https://international.bittrex.com/Home/Api) | Exchange based in the USA | `apiKey` | Yes | Unknown |
| [Coinbase](https://developers.coinbase.com) | Exchange based in the USA | `apiKey` | Yes | Unknown |
| [Gemini](https://docs.gemini.com/rest-api/) | Exchange based in the USA | No | Yes | Unknown |
| [Livecoin](https://www.livecoin.net/api) | Exchange | No | Yes | Unknown |
| [MercadoBitcoin](https://www.mercadobitcoin.net/api-doc/) | Exchange based in Brazil | No | Yes | Unknown |
| [Poloniex](https://poloniex.com/support/api/) | Exchange based in the USA | `apiKey` | Yes | Unknown |
